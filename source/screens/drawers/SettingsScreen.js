...
return (
    ...
    <ScrollView
      ...
      {selUser && (selUser.role == 'coordinator' && selUser.is_admin) &&
        ...
        // </View>
        <View style={{ padding: 10, backgroundColor: COLORS.gray400 }}>
          ...
          <>
            ...
            {usersCoord.length != 0 &&
              ...
              >
                ...
                /> */}
                <View style={{ borderWidth: 1, padding: SIZES.padding / 2, borderColor: COLORS.gray500, backgroundColor: COLORS.gray500, transform: [{ rotate: activeDropDown == 'coordinators' ? '90deg' : '0deg' }], borderRadius: SIZES.semiRadius}}>
                <Image
                source={icons.go}
            ...
            <View style={{ flex: 1 }}>
              ...
              {tellersCoord.length != 0 &&
                ...
                >
                  ...
                  /> */}
                  <View style={{ borderWidth: 1, padding: SIZES.padding / 2, borderColor: COLORS.gray500, backgroundColor: COLORS.gray500, transform: [{ rotate: activeDropDown == 'tellers' ? '-90deg' : '0deg' }], borderRadius: SIZES.semiRadius}}>
                <Image
                source={icons.go}
                style={{ height: 15, width: 15, tintColor: COLORS.black900 }}
              />
        ...
        <View style={{ flex: 1, justifyContent: 'flex-end' }}>
          ...
          {selUser && (selUser.role == 'coordinator' && selUser.is_admin &&  ableToViewMap) &&
            <>
              ...
              <TouchableOpacity style={{ paddingVertical: 1, marginVertical: SIZES.padding / 2 }} onPress={() => navigation.navigate('MapScreen', {})}>
                <View
                  style={{
          ...
          <TouchableOpacity style={{ paddingVertical: 1, marginVertical: SIZES.padding / 2 }} onPress={() => navigation.navigate('TestPrinter', {})}>
            <View
                  style={{
                    backgroundColor: '#ffffff',
                    elevation: 1,
