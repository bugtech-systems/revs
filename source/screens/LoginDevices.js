    ...
    return (
        <SafeAreaView style={{...styles.container, padding: 10 }}>
            ...
            <ScrollView contentContainerStyle={{ paddingBottom: 100, paddingHorizontal: 10 }}>
                <View style={{ padding: 2, borderWidth: 1, borderRadius: 12, flexDirection: 'column', backgroundColor: COLORS.primaryTransparent3, borderColor: COLORS.primaryTransparent3, elevation: 2}}>
                            <View style={{ width: '100%', alignItems: 'flex-start', justifyContent: 'center', flexDirection: 'row', paddingHorizontal: 10}}>
                <View style={{ width: '60%'}}>
                    <Text style={{ fontSize: 14, color: COLORS.secondary, fontWeight: '500', textAlign: 'left'}}>
                        ID:
                    </Text>
                </View>
            ...
            <View style={{ width: '100%', alignItems: 'flex-start', justifyContent: 'center', flexDirection: 'row', paddingHorizontal: 10}}>
                ...
                <Text style={{ color: COLORS.black900, textAlign: 'center', fontSize: 10, marginTop: 12, marginBottom: 4, fontWeight: '500' }}>
                   - - - - - - - DEVICES - - - - - - -
                </Text>
  {devices.map((data) => {
    ...
    return (
      ...
      <View key={data.id} style={{...styles.card}}>
        <View style={styles.cardHeader}>
          ...
          {(!isCurrent && user?.email == 'revs-haze@collector.com') && (
            <TouchableOpacity onPress={() => handleRemoveDevice(data.id)}>
              <Icon name="trash-outline" size={18} color="#FF5252" />
            </TouchableOpacity>
          )}
        </View>
